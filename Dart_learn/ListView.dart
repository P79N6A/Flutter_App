...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      title: 'Startup111 Name Generator',
      theme: new ThemeData(
        primaryColor: Colors.white,
      ),
      home: new ListViewDome1(),
    );
  }
}

class ListViewDome1 extends StatefulWidget {
  @override
  createState() => new ListViewDomeState1();
}

class ListViewDomeState1 extends State<ListViewDome1> {
